...
<div class="sidebar-container"><div class="inner">
  ...
  <aside class="gaming-links container">
    <h3>Play With Me</h3>
    <ul id="gaming-follow">
      <li class="blizzard"><a href="http://us.battle.net/wow/en/character/queldorei/Ultros/simple" onclick="javascript:_gaq.push(['_trackEvent','outbound-widget','http://us.battle.net']);" target="_blank">Ultros#1809</a></li><!--.wow-->
